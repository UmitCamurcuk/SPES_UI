...
function AttributeDetailsPage() {
  ...
  const handleUndoChanges = (e) => {
    SetAttributeData(attributeDataRAW);
    SetAttributeData((prevState) => ({
      ...prevState,
      'Type': attributeTypes.find(type => type.Code === attributeDataRAW.Type)
    }))
  ...
  return (
    <InternalLayout>
      <Grid container spacing={0}>
        <Grid mb={5} item xl={12} lg={12} md={12} sm={12} xs={12}>
          <Paper sx={{
            border: 'none',
            height: '50px',
            display: 'inline-flex',
        ...
        <Grid item xl={1} lg={1} md={2} sm={12} xs={12}>
          ...
          >
            ...
            <Tab label="Validations" {...a11yProps(1)} />
            <Tab label="Permissions" {...a11yProps(2)} />
            <Tab label="Associations" {...a11yProps(3)} />
            <Tab label="Calculations" {...a11yProps(4)} />
          </Tabs>
        </Grid>

        <Grid item xl={11} lg={11} md={8} sm={12} xs={12}>
          <TabPanel value={value} index={0}>
            <Grid container spacing={0}>
              ...
              <Grid mt={5} item xl={12} md={12} sm={12} xs={12}>
                <Typography
                  sx={{
                    fontSize: '18px'
                  }}
